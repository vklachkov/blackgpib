...
This is a project to emulate GPIB peripherals for the [GRiD Compass](https://en.wikipedia.org/wiki/Grid_Compass) computer using Raspberry Pi.
...
There is no illustrated guide, and there won't be one until a new version of the board is developed. If you are interested in assembling a prototype, you can find the board project files and their description in the [`hardware/pi-hat`](/hardware/pi-hat) folder.
...
The kernel from the official repository isn't working.
